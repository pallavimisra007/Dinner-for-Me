      ...
      <div className="about-body">
        ...
        <div className="about-text">
          ...
          <p>
            ...
            is not a complaint. Cooking for one is its own particular kind of
          ...
          <p>
            I grew up eating South Indian food at home and a fairly chaotic mix
            of everything else everywhere else. Singapore helped with that. You
            cannot live here and not end up eating and cooking across cuisines
            in ways that stop feeling deliberate after a while. So the recipes
            here are a mix: Levantine dips, Indonesian sambals, a Yemeni hot
            sauce, Indian chutneys, soups, roasted things, and whatever else I
            made that seemed worth remembering.
          </p>
          <p>
            A lot of these are adapted from recipes I found and cooked until
            they became versions I preferred. Some are things I made up or
            cobbled together. A few are things I figured out by accident and
            then tried to reverse-engineer. I write about what I was thinking,
            what didn't work the first time, and what I'd do differently — not
            because that's information you strictly need, but because that's
            what I actually want to read when I'm looking at a recipe.
          </p>
          <p>
            The site is called Dinner for Me. Most nights, that's exactly
            what it is.
          </p>
